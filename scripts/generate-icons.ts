...
/*
  ...
  - Produces components at src/icons/svg/<variant>/<relativePath>.tsx using SvgXml
  - Builds src/icons/registry.ts mapping: { [variant]: { [nameKey]: Component } }
  - Name key is the file path relative to the variant dir without extension (e.g. "notifications/bell-bing")
*/
...
function writeRegistry(
  ...
  const lines: string[] = [];
  lines.push("// Auto-generated by scripts/generate-icons.ts");
  lines.push("/* eslint-disable */");
  lines.push("import type { IconComponentProps as IconProps } from './types';");
  lines.push("");
  lines.push("");
  lines.push(

...
const OutlinePlaaylistMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlinePlaaylistMinimalistic };
export default React.memo(OutlinePlaaylistMinimalistic);

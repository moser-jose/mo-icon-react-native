...
const OutlineRewind10SecondsBack: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineRewind10SecondsBack };
export default React.memo(OutlineRewind10SecondsBack);

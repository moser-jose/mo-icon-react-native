...
const OutlineListArrowDownMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineListArrowDownMinimalistic };
export default React.memo(OutlineListArrowDownMinimalistic);

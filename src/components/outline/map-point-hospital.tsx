...
const OutlineMapPointHospital: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineMapPointHospital };
export default React.memo(OutlineMapPointHospital);

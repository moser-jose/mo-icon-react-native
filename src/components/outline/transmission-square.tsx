...
const OutlineTransmissionSquare: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineTransmissionSquare };
export default React.memo(OutlineTransmissionSquare);

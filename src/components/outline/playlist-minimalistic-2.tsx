...
const OutlinePlaylistMinimalistic2: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlinePlaylistMinimalistic2 };
export default React.memo(OutlinePlaylistMinimalistic2);

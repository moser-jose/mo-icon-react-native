...
const OutlineNotificationRemove: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineNotificationRemove };
export default React.memo(OutlineNotificationRemove);

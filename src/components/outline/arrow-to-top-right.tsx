...
const OutlineArrowToTopRight: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineArrowToTopRight };
export default React.memo(OutlineArrowToTopRight);

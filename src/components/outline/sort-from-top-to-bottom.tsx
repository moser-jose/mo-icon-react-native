...
const OutlineSortFromTopToBottom: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineSortFromTopToBottom };
export default React.memo(OutlineSortFromTopToBottom);

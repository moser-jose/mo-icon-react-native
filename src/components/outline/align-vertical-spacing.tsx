...
const OutlineAlignVerticalSpacing: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineAlignVerticalSpacing };
export default React.memo(OutlineAlignVerticalSpacing);

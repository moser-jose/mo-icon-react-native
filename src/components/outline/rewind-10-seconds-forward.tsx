...
const OutlineRewind10SecondsForward: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineRewind10SecondsForward };
export default React.memo(OutlineRewind10SecondsForward);

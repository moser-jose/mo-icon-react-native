...
const OutlineListDownMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineListDownMinimalistic };
export default React.memo(OutlineListDownMinimalistic);

...
const OutlineCalendarMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineCalendarMinimalistic };
export default React.memo(OutlineCalendarMinimalistic);

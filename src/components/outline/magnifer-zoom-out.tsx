...
const OutlineMagniferZoomOut: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineMagniferZoomOut };
export default React.memo(OutlineMagniferZoomOut);

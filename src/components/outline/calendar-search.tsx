...
const OutlineCalendarSearch: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineCalendarSearch };
export default React.memo(OutlineCalendarSearch);

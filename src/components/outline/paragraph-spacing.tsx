...
const OutlineParagraphSpacing: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineParagraphSpacing };
export default React.memo(OutlineParagraphSpacing);

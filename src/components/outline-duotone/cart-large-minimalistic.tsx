...
const OutlineDuotoneCartLargeMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { OutlineDuotoneCartLargeMinimalistic };
export default React.memo(OutlineDuotoneCartLargeMinimalistic);

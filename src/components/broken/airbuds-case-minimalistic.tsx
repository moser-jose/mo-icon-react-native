...
const BrokenAirbudsCaseMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BrokenAirbudsCaseMinimalistic };
export default React.memo(BrokenAirbudsCaseMinimalistic);

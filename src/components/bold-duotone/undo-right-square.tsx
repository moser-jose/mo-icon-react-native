...
const BoldDuotoneUndoRightSquare: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldDuotoneUndoRightSquare };
export default React.memo(BoldDuotoneUndoRightSquare);

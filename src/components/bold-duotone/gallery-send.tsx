...
const BoldDuotoneGallerySend: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldDuotoneGallerySend };
export default React.memo(BoldDuotoneGallerySend);

...
const BoldDuotoneSidebarMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldDuotoneSidebarMinimalistic };
export default React.memo(BoldDuotoneSidebarMinimalistic);

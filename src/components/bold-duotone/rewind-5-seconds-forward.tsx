...
const BoldDuotoneRewind5SecondsForward: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldDuotoneRewind5SecondsForward };
export default React.memo(BoldDuotoneRewind5SecondsForward);

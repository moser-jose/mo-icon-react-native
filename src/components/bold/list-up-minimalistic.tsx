...
const BoldListUpMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldListUpMinimalistic };
export default React.memo(BoldListUpMinimalistic);

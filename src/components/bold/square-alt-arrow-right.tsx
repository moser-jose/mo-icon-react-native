...
const BoldSquareAltArrowRight: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareAltArrowRight };
export default React.memo(BoldSquareAltArrowRight);

...
const BoldStarFallMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldStarFallMinimalistic };
export default React.memo(BoldStarFallMinimalistic);

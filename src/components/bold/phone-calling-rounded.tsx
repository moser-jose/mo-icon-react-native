...
const BoldPhoneCallingRounded: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldPhoneCallingRounded };
export default React.memo(BoldPhoneCallingRounded);

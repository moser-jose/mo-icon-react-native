...
const BoldSquareTransferVertical: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareTransferVertical };
export default React.memo(BoldSquareTransferVertical);

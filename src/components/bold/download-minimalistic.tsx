...
const BoldDownloadMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldDownloadMinimalistic };
export default React.memo(BoldDownloadMinimalistic);

...
const BoldSquareDoubleAltArrowRight: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareDoubleAltArrowRight };
export default React.memo(BoldSquareDoubleAltArrowRight);

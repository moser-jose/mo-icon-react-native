...
const BoldSortFromTopToBottom: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSortFromTopToBottom };
export default React.memo(BoldSortFromTopToBottom);

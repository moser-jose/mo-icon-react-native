...
const BoldLaptopMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldLaptopMinimalistic };
export default React.memo(BoldLaptopMinimalistic);

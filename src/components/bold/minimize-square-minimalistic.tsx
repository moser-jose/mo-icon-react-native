...
const BoldMinimizeSquareMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldMinimizeSquareMinimalistic };
export default React.memo(BoldMinimizeSquareMinimalistic);

...
const BoldSquareDoubleAltArrowLeft: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareDoubleAltArrowLeft };
export default React.memo(BoldSquareDoubleAltArrowLeft);

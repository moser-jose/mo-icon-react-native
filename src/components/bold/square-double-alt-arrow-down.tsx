...
const BoldSquareDoubleAltArrowDown: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareDoubleAltArrowDown };
export default React.memo(BoldSquareDoubleAltArrowDown);

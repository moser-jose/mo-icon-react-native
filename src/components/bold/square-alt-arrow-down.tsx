...
const BoldSquareAltArrowDown: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareAltArrowDown };
export default React.memo(BoldSquareAltArrowDown);

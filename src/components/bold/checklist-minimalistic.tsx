...
const BoldChecklistMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldChecklistMinimalistic };
export default React.memo(BoldChecklistMinimalistic);

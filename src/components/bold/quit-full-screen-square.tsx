...
const BoldQuitFullScreenSquare: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldQuitFullScreenSquare };
export default React.memo(BoldQuitFullScreenSquare);

...
const BoldDownloadTwiceSquare: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldDownloadTwiceSquare };
export default React.memo(BoldDownloadTwiceSquare);

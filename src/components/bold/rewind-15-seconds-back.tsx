...
const BoldRewind15SecondsBack: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldRewind15SecondsBack };
export default React.memo(BoldRewind15SecondsBack);

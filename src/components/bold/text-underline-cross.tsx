...
const BoldTextUnderlineCross: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldTextUnderlineCross };
export default React.memo(BoldTextUnderlineCross);

...
const BoldOvenMittsMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldOvenMittsMinimalistic };
export default React.memo(BoldOvenMittsMinimalistic);

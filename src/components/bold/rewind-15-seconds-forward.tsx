...
const BoldRewind15SecondsForward: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldRewind15SecondsForward };
export default React.memo(BoldRewind15SecondsForward);

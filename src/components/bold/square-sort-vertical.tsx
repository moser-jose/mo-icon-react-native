...
const BoldSquareSortVertical: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldSquareSortVertical };
export default React.memo(BoldSquareSortVertical);

...
const BoldHikingMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldHikingMinimalistic };
export default React.memo(BoldHikingMinimalistic);

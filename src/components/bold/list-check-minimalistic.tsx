...
const BoldListCheckMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldListCheckMinimalistic };
export default React.memo(BoldListCheckMinimalistic);

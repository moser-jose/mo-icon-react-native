...
const BoldCaseRoundMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldCaseRoundMinimalistic };
export default React.memo(BoldCaseRoundMinimalistic);

...
const BoldUndoRightRoundSquare: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldUndoRightRoundSquare };
export default React.memo(BoldUndoRightRoundSquare);

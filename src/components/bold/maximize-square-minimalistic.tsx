...
const BoldMaximizeSquareMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldMaximizeSquareMinimalistic };
export default React.memo(BoldMaximizeSquareMinimalistic);

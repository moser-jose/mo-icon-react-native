...
const BoldListArrowUpMinimalistic: React.FC<IconProps> = ({ size = 24, color = '#1C274C', ...props }) => {
...
export { BoldListArrowUpMinimalistic };
export default React.memo(BoldListArrowUpMinimalistic);
